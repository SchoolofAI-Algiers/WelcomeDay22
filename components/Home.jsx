...
export default function Home() {
  return (
    <div
      className="flex items-center mx-5 md:mx-auto pb-16 md:h-screen md:pb-10 pt-16 md:pt-24"
      id="Home"
    >
      <div className="sm:px-4 text-white lg:w-4/6 sm:mx-2 md:ml-10 xl:ml-16">
        ...
        <p className="lg:text-sm text-xxs md:max-w-2xl lg:leading-6 leading-5">
